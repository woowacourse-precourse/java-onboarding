...
### PROBLEM 2
2.1 정규 표현식으로 중복되는 알파벳 소문자를 교체한다. 
2.2 중복되는 소문자가 존재하지 않을 때까지 교체한다. 
2.3 입력
  2.3.1 임의의 문자열 cryptogram이 매개변수로 주어진다.
2.4 출력
  2.4.1 연속하는 중복 문자를 삭제한 결과를 return 한다.
  2.4.2 빈문자열도 return 한다. 
