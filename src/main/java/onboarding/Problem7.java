...
public class Problem7 {
    public static List<String> solution(String user, List<List<String>> friends, List<String> visitors) {
        ...
        // user의 친구의 친구 리스트
        ArrayList<String> friendOfFriend = friendOfFriend(user, friends, friendsList);

        // user와 함께 아는 친구의 수 카운트
        HashMap<String, Integer> count = count(friendOfFriend, friends);
    ...
    public static ArrayList friendOfFriend(String user, List<List<String>> friends, List<String> friendsList) {
