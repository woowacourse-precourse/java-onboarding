...
- [x] FEATURE1. 사용자의 친구 목록 생성 함수
- [x] FEATURE2. 사용자의 추천 친구 목록 생성 함수
- [x] FEATURE3. 사용자와 함께 아는 친구 점수 계산 함수
- [x] FEATURE4. 사용자의 타임 라인을 방문한 횟수 점수 계산 함수
- [x] FEATURE5. 기능 요구 사항에 맞는 추천 친구 목록 정렬 및 5명 슬라이싱 함수
- [x] FEATURE6. 점수 포함 hashmap combine 함수
