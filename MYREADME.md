...
## 7번 문제
- 유저는 이름과 친구목록을 가진다[]
- 유저 이름으로 해당 유저를 찾는 기능[]
- 하나의 친구관계가 주어질 때 각 유저에 친구관계 적용[]
- 여러개의 친구관계가 주어질 때 각각의 유저에 친구관계 적용[]
- 모든 유저 추천 리스트를 만드는 기능[]
- 만든 유저 추천 리스트 중 주어진 유저와 친구관계인 유저 리스트에서 제거[]
- 유저와 함께하는 친구의 수 기준으로 점수 계산[]
- 유저가 타임라인에 방문한 횟수를 기준으로 점수 계산[]
