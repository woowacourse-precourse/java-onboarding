...
public class Problem2 {
    ...
    private static int decipherCode(List<String> code, int idx) {
    ...
    private static boolean decipherFinish(List<String> str, int idx) {
        return str.size() == idx || str.size() == 0;
    }

    private static boolean isDuplicate(List<String> str, int idx) {
        return str.get(idx-1).equals(str.get(idx));
    }

    private static void removeDuplicate(List<String> strList, int idx) {
        strList.remove(idx);
