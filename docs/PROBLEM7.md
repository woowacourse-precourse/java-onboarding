...
- [x] 나와 내 친구들은 친구 추천 목록에 포함되지 않으므로 **내 친구 목록**을 만든다.
- [x] 나와 내 친구들이 아닌 다른 사람들은 친구 추천을 받아 점수를 얻을 수 있으므로 점수 목록에 넣는다.
- [x] 내 친구의 친구인 사람은 10점, 방문자는 1점을 부여한다.
- [x] 점수 목록을 정렬하여 상위 5명을 뽑는다. 이 때 점수가 0점인 사람은 제외한다.