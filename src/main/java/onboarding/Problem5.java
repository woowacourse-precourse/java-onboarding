...
public class Problem5 {
    public static List<Integer> solution(int money) {
        List<Integer> answer = getWithDrawList(money);
        return answer;
    }

    //돈을 환급할 화폐 리스트
    private static final int[] currencyList = {50000, 10000, 5000, 1000, 500, 100, 50, 10, 1};
     ...
     */
    private static List<Integer> getWithDrawList(int money){
        // 결과로 반환할 리스트를 초기화
