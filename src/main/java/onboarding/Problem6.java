...
/**
 * 배운점
 * 1. List 형식으로 주어진 정보를 Class로 변환하여 더욱 명확하게 추상화할 수 있다.
 * 2. 현재 중복을 확인하는 로직(dupNameCheck)이 깔끔하지 않다고 생각한다. (현재 두글자만 떼서 비교)
 * 하지만 로직을 따로 함수로 빼놓아 의존도를 낮춤으로써 추후에 개선하기 쉽도록 하였다.
 */