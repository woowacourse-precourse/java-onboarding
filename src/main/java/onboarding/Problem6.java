...
public class Problem6 {
    public static List<String> solution(List<List<String>> forms) {
        ...
        listMake(forms, answer);

        return answer;
    }

    private static void listMake(List<List<String>> forms, List<String> answer) {
        ...
        nestedRecursion(forms, (List<String> form1, List<String> form2) -> {
            ...
            if (Common.isCommon(form1.get(1), form2.get(1))) addForm(formSet, form1, form2);
            return false;
        });

        formSet.forEach(form -> {
            answer.add(form.get(1));
        });
