 ...
 * 닉네임이 중복(두 글자 이상의 문자가 연속적으로 순서에 맞추어 포함되어 있는 경우)이면 유효하지 않은 신청 폼이다.
 * @author yoondgu
 *
 */
public class FormValidator {
     ...
     * usedTwoWordsInfo는 두 글자 문자열과 이를 사용한 신청 폼 리스트를 저장하는 Map타입의 변수이다.
     * key값으로 중복을 허용하지 않는 두 글자 문자열, 
     * value값으로 해당 key값을 닉네임에 사용하는 모든 신청 폼 객체의 리스트를 가진다.
     * @param form
     */
    ...
    /**
     * usedTwoWordsInfo를 이용해 invalidForms를 초기화한다.
     * 초기화되는 값은 중복 닉네임을 신청한 모든 폼 객체의 리스트이다.
     */
