...
public class Problem6 {
    ...
    //key를 확인한다.
    public static boolean validateKey(Map<String, String> map, String subName) {
        return map.containsKey(subName);
    }
