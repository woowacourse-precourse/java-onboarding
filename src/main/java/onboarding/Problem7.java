 ...
 * 2. 유저의 친구의 친구에 대해 점수 증가
 * 3. 유저의 타임라인의 방문자에게 점수부여 (이때 친구는 증가 시켜선 안된다)
 * 4. 점수가 가장 높은 순으로 정렬하여 최대 5명 출력, 같을시에는 이름순정렬
...
public class Problem7 {
    private static class User {
        ...
        HashMap<String, Integer> recommendFriendsList = new HashMap<>();
