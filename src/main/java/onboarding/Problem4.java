...
public class Problem4 {
    public static String solution(String word) {
        ...
        for (char letter : word.toCharArray()) {
            convertedWord.append(convertWithDictionary(letter));
        }
    ...
    static char convertWithDictionary(char letter) {
        ...
        if (Character.isUpperCase(letter)) {
            return (char) (ALPHABET_UPPERCASE_END - (letter - ALPHABET_UPPERCASE_START));
        }
        if (Character.isLowerCase(letter)) {
            return (char) (ALPHABET_LOWERCASE_END - (letter - ALPHABET_LOWERCASE_START));
        }
        return letter;
    }
}
