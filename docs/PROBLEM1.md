...
1. 연속된 숫자 && 홀짝수 확인기능
2. 받은 숫자 범위 확인(시작 면이나 마지막 면이 나오도록 책을 펼치지 않는다.)
3. 페이지 번호의 각 자리 숫자를 모두 더하는 기능
4. 페이지 번호의 각 자리 숫자를 모두 곱하는 기능.
5. 페이지 번호 중에서 제일 큰수를 기능
6. 점수를 비교해 가장 높은 사람이 게임의 승자를 구하는 기기
