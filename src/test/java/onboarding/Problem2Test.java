...
class Problem2Test {
    ...
    void 테스트케이스() {
        ...
        Assertions.assertThat(Problem2.solution("zyellleyz")).isEqualTo("");
        Assertions.assertThat(Problem2.solution("zyalllelyz")).isEqualTo("zyaelyz");
        Assertions.assertThat(Problem2.solution("aabba")).isEqualTo("a");
        Assertions.assertThat(Problem2.solution("abbaa")).isEqualTo("a");
        Assertions.assertThat(Problem2.solution("aazzqweqweaaq")).isEqualTo("qweqweq");
        Assertions.assertThat(Problem2.solution("ksekkset")).isEqualTo("kseset");
        Assertions.assertThat(Problem2.solution("ksekkset")).isEqualTo("kseset");
    }
}
