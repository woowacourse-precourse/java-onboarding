...
class ApplicationTest {
    ...
    class Problem7Test {
        ...
        void case3() {
            ...
            List<String> visitors = List.of("bedi", "donut", "shakevan");
            List<String> result = List.of("bedi", "shakevan");
            assertThat(Problem7.solution(user, friends, visitors)).isEqualTo(result);
        }
        ...
        void case4() {
            ...
            List<String> visitors = List.of("zbedi", "donut", "shakevan");
            List<String> result = List.of("shakevan", "zbedi");
            assertThat(Problem7.solution(user, friends, visitors)).isEqualTo(result);
        }
        ...
        void case10() {
            ...
            List<String> result = List.of("bedi");
            assertThat(Problem7.solution(user, friends, visitors)).isEqualTo(result);
        }
    }
}
