...
class ApplicationTest {
    ...
    class Problem2Test {
        ...
        @Test
        void case5() {
            String cryptogram = "browoamoommnaon";
            String result = "browoamnaon";
            assertThat(Problem2.solution(cryptogram)).isEqualTo(result);
        }
    }
    ...
    class Problem4Test {
        ...
        @Test
        void case2() {
            String word = "4I love you4";
            String result = "4R olev blf4";
            assertThat(Problem4.solution(word)).isEqualTo(result);
        }
    ...
    class Problem6Test {
        ...
        void case2() {
            List<List<String>> forms = List.of(
                    ...
                    List.of("mj@email.com", "엠제이"),
                    List.of("nowm@email.com", "이제엠"),
                    List.of("barojm@email.com", "바로제이엠"),
                    List.of("codingejm@email.com", "코딩이제이엠")
            );
            List<String> result = List.of("barojm@email.com","codingejm@email.com","jason@email.com", "jm@email.com", "mj@email.com","nowm@email.com");
            assertThat(Problem6.solution(forms)).isEqualTo(result);
        }
        @Test
        void case3(){
