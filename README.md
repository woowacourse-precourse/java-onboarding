...
### 매개변수 확인
- [ ] cryptogram가 길이가 1 이상 1000 이하인 문자열인지 확인
- [ ] cryptogram가 알파벳 소문자로만 이루어져 있는지 확인
### 처리
- [ ] 지울 문자가 있는지 확인하는 메서드 구현
- [ ] 문자열이 주어지면 연속으로 중복되는 문자 확인해서 지우는 메서드 구현
- [ ] 더이상 지울 문자가 없을 때 까지 문자열 지우기 반복
