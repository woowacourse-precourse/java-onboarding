...
- [ ] 주어진 리스트가 있는지 알 수 있다. - Calculator.hasList()
  - [ ] 주어진 리스트가 없으면 책을 임의로 펼친다(1 ~ 400범위의 수를 생성한다) - Book.openBook()
    ...
    3. - [ ] 각 페이지의 각 자리 숫자를 더한 값과 곱한 값을 비교하여 저장한다. - Book.setPageScore()
    4. - [ ] 왼쪽, 오른쪽 페이지의 각 자리 숫자를 더한 값과 곱한 값을 비교하여 가장 큰 값을 최종 점수에 저장한다. - Book.setLastScore()
  - [ ] 주어진 리스트가 있으면 b, c, d 과정을 거친다.
