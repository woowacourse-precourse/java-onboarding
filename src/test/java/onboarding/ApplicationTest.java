...
class ApplicationTest {
    ...
    class Problem1Test {
        ...
        @Test
        void case4() {
            List<Integer> pobi = List.of(99, 100, 101);
            List<Integer> crong = List.of(101, 102, 103);
            int result = -1;
            assertThat(Problem1.solution(pobi, crong)).isEqualTo(result);
        }
        ...
        void case6() {
            ...
            List<Integer> crong = List.of(101, 104);
            int result = -1;
            assertThat(Problem1.solution(pobi, crong)).isEqualTo(result);
        }
    ...
    class Problem4Test {
        ...
        @Test
        void case2() {
            String word = "나는 너를 love ";
            String result = "나는 너를 olev ";
            assertThat(Problem4.solution(word)).isEqualTo(result);
        }
    ...
    class Problem6Test {
        ...
        void case2() {
            List<List<String>> forms = List.of(
                    ...
                    List.of("mj@email.com", "엠제이"),
                    List.of("nowm@email.com", "이제엠"),
                    List.of("wonnnie@email.com", "이워니")
            );
            List<String> result = List.of("jason@email.com", "jm@email.com", "mj@email.com", "woniee@email.com", "wonnnie@email.com");
            assertThat(Problem6.solution(forms)).isEqualTo(result);
        }
