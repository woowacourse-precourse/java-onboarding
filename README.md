...
- [ ] 이메일이 @email.com으로 끝나고 길이가 11자 이상 20자 미만인지 확인하는 함수 구현
- [ ] 닉네임의 두 글자씩 가져와서 HashMap에 (key 닉네임 두 글자 value 갯수 + 1)을 넣는다.
- [ ] 반복문을 돌아 두 글자 닉네임이 2개 이상 있으면 List에 넣는다.
- [ ] 모든 닉네임을 판단 했으면 Set을 List로 만들고 정렬한다.