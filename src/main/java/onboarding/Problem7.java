...
public class Problem7 {
    ...
    private static void removeNotRecommendFriendInScoreMap(String user, HashMap<String, HashSet<String>> friendMap, HashMap<String, Integer> scoreMap) {
    ...
    private static void removeExistFriendInScoreMap(String user, HashMap<String, HashSet<String>> friendMap, HashMap<String, Integer> scoreMap) {
