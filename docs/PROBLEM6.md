...
- [ ] 닉네임을 상세 검증 할수 있다.
- [ ] 닉네임에 같은 글자가 연속으로 포함 되었는지 알수 있다. 
- [ ] 닉네임 마다, 두 글자 이상의 문자가 연속적으로 순서에 맞추어 포함되어 있는 경우지 알수 있다.
- [ ] 2글자 이상과 각 글자 수 마다 가능한 모든 수를 전부 구할수 있다.
- [ ] 닉네임으로 모든 수를 체크하여 중복 닉네임으로 판단 할수 있다.
- [ ] 닉네임에 해당하는 이메일 주소를 담아서 리턴한다.
